...
public class CodingTest {
    public static void main(String[] args) {
        CodingTestSolution solution = new CodingTestSolution();
        int[][] passwords = {
                {101,9999},
                {102,1111}
        };

        System.out.println(solution.solution(passwords,"101#9999#102#1111#101#9999#101#9999#"));
    }
}

class CodingTestSolution {
    public int solution(int[][] passwords, String s) {
        ...
        for(String str : strArr) {
            if(flag) {
                tmp = map.get(Integer.parseInt(str));
                flag = false;
            } else {
                if(tmp != null && Integer.parseInt(str) == tmp){
                    count++;
                }
                flag = true;
            }
